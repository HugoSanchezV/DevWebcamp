<fieldset class="formulario__fieldset">
    ...
    <div class="formulario__campo formulario__input--file">
    ...
    <?php if(isset($ponente->imagen_actual)): ?>
        ...
        <div class="formulario__imagen">
            <picture>
                ...
                <img loading="lazy" width="100%" height="100%" src=".jpg" alt="Imagen Ponente">
            </picture>
        </div>
    <?php endif; ?>
</fieldset>
...
<fieldset class="formulario__fieldset">
    ...
    <div class="formulario__campo">
        <label for="tags_input" class="formulario__label">Áreas de Experiencia (sepradas por coma)</label>
...
<fieldset class="formulario__fieldset">
    ...
    <div class="formulario__campo">
        <div class="formulario__contenedor-icono">
            ...
            <input type="text" class="formulario__input--sociales" name="redes[facebook]" placeholder="Facebook" value="<?php echo $redes->faceboook ?? ''; ?>">
        </div>
    </div>

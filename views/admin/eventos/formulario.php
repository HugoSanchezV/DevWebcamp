<fieldset class="formulario__fieldset">
    ...
    <div class="formulario__campo">
        ...
        <textarea rows="8" class="formulario__input" id="descripcion" name="descripcion" placeholder="Descripción Evento" value="<?php echo $evento->descripcion ?? ''; ?>"><?php echo $evento->descripcion ?? ''; ?></textarea>
    </div>

...
<section class="resumen">
    <div class="resumen__grid">
        <div data-aos="<?php echo aos_animacion(); ?>" class="resumen__bloque">
...
<main class="speakers">
    ...
    <div class="speakers__grid">
        <?php foreach ($ponentes as $ponente) : ?>
            <div data-aos="<?php echo aos_animacion(); ?>" class="speaker">
                <picture>
                    <source srcset="<?php echo $_ENV['HOST'] . '/img/speakers/' . $ponente->imagen; ?>.webp" type="image/webp">
                    <source srcset="<?php echo $_ENV['HOST'] . '/img/speakers/' . $ponente->imagen; ?>.png" type="image/png">
                    <img class="speaker__imagen" width="200" height="300" loading="lazy" width="100%" height="100%" src=".jpg" alt="Imagen Ponente">
                </picture>
...
<section class="boletos">
    ...
    <p class="boletos__descripcion">Boletos Descripción</p>

    <div data-aos="<?php echo aos_animacion(); ?>" data-aos-once="true" class="boletos__grid">
